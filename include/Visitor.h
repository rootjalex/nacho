...
struct Visitor {
    ...
    virtual void visit(const llir::lSelect *);
    ...
    virtual void visit(const llir::RawExpr *);
    virtual void visit(const llir::lLambda *);
    virtual void visit(const llir::Cast *);
    ...
    virtual void visit(const llir::RawStmt *node);
};
