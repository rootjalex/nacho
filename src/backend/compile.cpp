...
namespace backend {
    ...
    void CINLowerer::lower_struct_definitions(int last_sparse_intersection) {
        ...
        auto result_operand_pos_map = lower_result_pos_to_operand_pos_map_struct(LoopNum(last_sparse_intersection));
    ...
    llir::lType CINLowerer::lower_result_pos_to_operand_pos_map_struct(LoopNum last_sparse_intersection) {
        ...
        for(int level=0; level<=last_sparse_intersection.get();level++) {
